                    ...
                    <div class="card-body">
                        ...
                        <form action="/postEditBuku/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="text" class="form-control border border-secondary" name="judulBuku"
                                    required value="{{ $data->judul_buku }}">
                                <span class="text-danger">
                                    @error('judulBuku')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="text" class="form-control border border-secondary" name="penulis"
                                    required value="{{ $data->penulis }}">
                                <span class="text-danger">
                                    @error('penulis')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="text" class="form-control border border-secondary" name="penerbit"
                                    required value="{{ $data->penerbit }}">
                                <span class="text-danger">
                                    @error('penerbit')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="text" class="form-control border border-secondary" name="tahunTerbit"
